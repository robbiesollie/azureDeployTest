...
<section>
    ...
    <form>
        ...
        <div class="form-group">
            <label for="proposal">Project Description: </label>
            <textarea id = "proposal" rows="6" cols="78" placeholder="Describe the project">Please place a description of the project you would like to advertise.</textarea>
