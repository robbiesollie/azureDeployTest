    ...
    <form>
        <div class = "form-group">
            ...
            <label for = "type">
                ...
                A project provider is someone who would like to post a project for people to work on
            </label>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="userName" aria-describedby="name" placeholder="UserName">
        </div>
        <div class="form-group">
